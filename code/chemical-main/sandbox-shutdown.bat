...
title Chaotu (SuperMap) Sandbox Shutdown

set "ROOT=%~dp0"
set "ROOT=%ROOT:~0,-1%"
set "MYSQL_CONTAINERS=chaotu-mysql"
set "PORTS=8100 8101 8181 6173"
...
echo.
echo ==========================================
echo  Chaotu (SuperMap) Sandbox Shutdown
echo ==========================================
...
netstat -ano -p tcp | findstr /R /C:":3407 .*LISTENING" >nul 2>nul
if "%ERRORLEVEL%"=="0" (echo   MySQL 3407: LISTENING) else (echo   MySQL 3407: stopped)
